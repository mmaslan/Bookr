...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(help_text='Imię lub imiona współtwórców.', max_length=50)),
                ('last_name', models.CharField(help_text='Nazwisko lub nazwiska współtwórców', max_length=50)),
